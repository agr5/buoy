...
As output measures to consider model performance we will use two metrics:
...
## Results
Our tope performer model seems to be the random forest regressor which outperforms all the other considered models on the cross validation test we used, and improves our baseline average model by reducing the RMSE by 74% and the MAE  in 76% in comparison.
